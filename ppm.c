...
void ppm_write_to_file(int width, int height, u_char* data, FILE* file, char * namefile);

// Read the image contained in plain RGB ppm file <file>
// into <data> and set <width> and <height> accordingly
// Warning: data is malloc_ed, don't forget to free it
void ppm_read_from_file(int *width, int *height, u_char** data, FILE* file, char * namefile);
...
int main(int argc, char* argv[])
{
  ...
  ppm_read_from_file(&width, &height, &image, ppm_input, namefile);
  ...
  ppm_write_to_file(width, height, image_bw, ppm_output, BW_image);
  ...
  ppm_write_to_file(width_small, height_small, image_small, ppm_output, small_image);
